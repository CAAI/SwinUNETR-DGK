...
parser.add_argument('--pretrained_model_name', default='best_metric_model_fold3.pth', type=str, help='pretrained model name') # DGK SET each
...
def main():
    ...
    args.test_mode = True
    output_directory = '/homes/kovacs/project_data/hnc-auto-contouring/MONAI/Task500_HNC01/output/m3/'+args.exp_name
