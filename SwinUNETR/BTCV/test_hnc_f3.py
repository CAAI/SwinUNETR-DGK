...
parser.add_argument('--exp_name', default='test196_m3', type=str, help='experiment name') # DGK SET for each model
parser.add_argument('--json_list', default='dataset_test196.json', type=str, help='dataset json file') # DGK SET
parser.add_argument('--pretrained_model_name', default='best_metric_model_fold3.pth', type=str, help='pretrained model name') # DGK SET for each model
