...
parser.add_argument('--pretrained_model_name', default='best_metric_model_fold0.pth', type=str, help='pretrained model name') # DGK SET
...
def main():
    ...
    args.test_mode = True
    output_directory = '/homes/kovacs/project_data/hnc-auto-contouring/MONAI/Task500_HNC01/output/'+args.exp_name
